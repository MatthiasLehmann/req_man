...
import { Save, X, Link2, Tag, ChevronDown, ChevronUp, Loader2, GitCommit, History, Stamp, Paperclip, AlertTriangle } from 'lucide-react';
...
export default function ItemEditor({ projectId, uid, onClose, onDirtyChange }: Props) {
  ...
  const [activeTab, setActiveTab] = useState<'details' | 'references' | 'validation'>('details');
